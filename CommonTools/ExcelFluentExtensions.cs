...
public static class ExcelFluentExtensions
{
    ...
    public static SpreadsheetDocument AppendWorksheet(this SpreadsheetDocument spreadsheetDocument, string sheetName, IEnumerable<IEnumerable<object>> rows, params IEnumerable<object>[] headerSets)
    {
